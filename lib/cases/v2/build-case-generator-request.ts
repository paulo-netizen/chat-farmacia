...
export const CASE_GENERATOR_INSTRUCTIONS_V2 = [
  ...
  'EVIDENCIA: Toda conclusión que admita EvidenceRule debe tener una regla basada únicamente en hechos locales existentes o en public_profile.age/public_profile.sex. No uses inferencias ocultas ni trates un hecho ausente como negativo.',
