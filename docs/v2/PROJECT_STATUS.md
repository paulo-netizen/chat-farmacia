...
- **M5:** **CLOSED / COMPLETE**.
- **Suite actual:** **2747 PASS / 25 SKIPPED**.
- **TypeScript:** **PASS**.
...
Pendiente: aceptación live M6-D3B completa desde SMOKE bajo matriz `/7` (`gpt-5.6-terra`), reglas clínicas versionadas, scoring, persistencia e integración con la evaluación global. M6-D3B sigue `NOT CLOSED — READY FOR TERRA LIVE ACCEPTANCE FROM SMOKE`; `/6` no se repite para buscar un PASS. Matrix `/7` queda `PENDING LIVE ACCEPTANCE`, fingerprint `9194a30c2b7574e000d87571166d4d42384200b908654e7e048fc180188cfab9`. No hay aceptación farmacéutica de Terra ni afirmación de superioridad. Véanse el [modelo de evaluación](04_EVALUATION_MODEL.md) y la [matriz live pre-registrada](18_PHARMACEUTICAL_SEMANTIC_LIVE_ACCEPTANCE.md).
