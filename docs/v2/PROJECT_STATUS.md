...
- **M5:** **CLOSED / COMPLETE**.
- **Suite actual:** **2793 PASS / 25 SKIPPED**.
- **TypeScript:** **PASS**.
...
Subdivisión fija de M6-D dentro del milestone: M6-D1A = 3% (CLOSED), M6-D1B = 4% (CLOSED), M6-D2A = 2% (CLOSED), M6-D2B = 2% (CLOSED), M6-D3A = 1% (CLOSED) y M6-D3B = 2% (PENDING). **M6-D1 = CLOSED / COMPLETE. M6-D2 = CLOSED / COMPLETE. M6-D3 = PARTIAL. M6-D = PARTIAL**.

Pendiente: aceptación live M6-D3B desde SMOKE bajo matrix `/9` (`gpt-5.6-terra`). M6-D3R16 — **CLOSED / COMPLETE**, validado offline (relaciones 39, D2 199, D1 142, harness 83; suite 2793 PASS / 25 SKIPPED, TypeScript y diff-check PASS): request D2 `/2` añade únicamente la proyección relacional positiva ya presente en M6-C. M6-D3B sigue **NOT CLOSED**. Matrix `/8`: histórico **REJECT** con Terra y request relacional `/2`, fingerprint `18d8de2f85bbe40b9bd9389f87ebeb4d95a1b4861385fd62635ea32dc850e486`. `/6` Sol y `/7` Terra permanecen `REJECT`. D3R17 concluyó **A — D2 PROMPT GAP**: presencia de componentes no equivale a cobertura de la proposición. D3R18 está **CLOSED / COMPLETE** offline (D2 216, D1 142, harness 91; suite 2818 PASS / 25 SKIPPED; TypeScript y diff-check PASS): prompt D2 `/4`, request `/2` y matrix `/9` **PENDING LIVE ACCEPTANCE**, fingerprint `56e31f12ae545bf6e3b814731faa70be5b3f304a20397ad5a61513c49633844c`. M6-D3B sigue **NOT CLOSED — READY FOR PROMPT-V4 LIVE ACCEPTANCE FROM SMOKE**. No hay nuevas ejecuciones ni aceptación farmacéutica de ningún candidato; M6 46% / proyecto 49.37% sin cambios. Se conservan los pendientes de reglas clínicas versionadas, scoring, persistencia e integración global. Véanse el [modelo de evaluación](04_EVALUATION_MODEL.md) y la [matriz live pre-registrada](18_PHARMACEUTICAL_SEMANTIC_LIVE_ACCEPTANCE.md).
