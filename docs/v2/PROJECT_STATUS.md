...
- **M5:** **CLOSED / COMPLETE**.
- **Suite actual:** **2648 PASS / 25 SKIPPED**.
- **TypeScript:** **PASS**.
...
Pendiente: nueva aceptación live M6-D3B completa desde SMOKE bajo matriz `/5`, reglas clínicas versionadas, scoring, persistencia e integración con la evaluación global. `gpt-5.6-sol` sigue siendo candidato y no se considera aceptado productivamente. Véanse el [modelo de evaluación](04_EVALUATION_MODEL.md) y la [matriz live pre-registrada](18_PHARMACEUTICAL_SEMANTIC_LIVE_ACCEPTANCE.md).
