...
- **M5:** **CLOSED / COMPLETE**.
- **Suite actual:** **2400 PASS / 24 SKIPPED**.
- **TypeScript:** **PASS**.
...
| M6 | Evaluación farmacéutica/PRM–RNM/adherencia | PARTIAL | 37% | 12% | 4.44% |
...
Subdivisión fija de M6-D dentro del milestone: M6-D1A = 3% (CLOSED), M6-D1B = 4% (PENDING), M6-D2 = 4% (PENDING) y M6-D3 = 3% (PENDING). **M6-D = PARTIAL**.

Pendiente: ejecución semántica D1B, claim lane D2, hardening/aceptación D3, reglas clínicas versionadas, scoring, persistencia e integración con la evaluación global. Véase el [modelo de evaluación](04_EVALUATION_MODEL.md).
