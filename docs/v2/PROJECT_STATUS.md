...
Pendiente: aceptación live M6-D3B desde SMOKE bajo matrix `/8` (`gpt-5.6-terra`). M6-D3R16 — **CLOSED / COMPLETE**, validado offline (relaciones 39, D2 199, D1 142, harness 83; suite 2793 PASS / 25 SKIPPED, TypeScript y diff-check PASS): request D2 `/2` añade únicamente la proyección relacional positiva ya presente en M6-C. M6-D3B sigue **NOT CLOSED — READY FOR RELATIONAL-PROJECTION LIVE ACCEPTANCE**. Matrix `/8`: **PENDING LIVE ACCEPTANCE**, fingerprint `18d8de2f85bbe40b9bd9389f87ebeb4d95a1b4861385fd62635ea32dc850e486`. `/6` Sol y `/7` Terra permanecen `REJECT`, sin nuevas ejecuciones ni aceptación farmacéutica de ningún candidato. Se conservan los pendientes de reglas clínicas versionadas, scoring, persistencia e integración global. Véanse el [modelo de evaluación](04_EVALUATION_MODEL.md) y la [matriz live pre-registrada](18_PHARMACEUTICAL_SEMANTIC_LIVE_ACCEPTANCE.md).
